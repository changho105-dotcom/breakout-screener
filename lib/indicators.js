 ...
 */
function evaluateStock({ ticker, name, sector, highs, closes, lows, volumes, indexCloses, indexRegime, sectorAvgReturn, market, lookback }) {
  ...
  // 개별 종목 강도(%): 시장국면을 제외한 종목 고유 조건(신고가근접·거래량·돌파) 3개 중 통과 비율
  const stockCriteria = [checklist.relativeStrengthOk, checklist.volumeSurgeOk, checklist.breakoutOk];
