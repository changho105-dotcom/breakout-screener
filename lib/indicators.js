...
function evaluateStock({ ticker, name, sector, highs, closes, volumes, indexCloses, indexRegime, sectorAvgReturn, market }) {
  ...
  const checklist = {
    ...
    relativeStrengthOk: highDistance !== null && highDistance >= CONFIG.nearHighThreshold, // 36주 신고가 -20% 이내 근접
  ...
  return {
    ...
    relativeStrength: highDistance, // 필드명은 유지(프론트 호환), 의미는 "36주 신고가 대비 위치"
